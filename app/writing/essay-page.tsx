...
export default async function EssayPage({ essayFileName }: EssayPageProps) {
  const essayPath = path.join(process.cwd(), "content", "essays", essayFileName);
        ...
        <div className="w-full rounded-[2rem] border border-stone-700/10 bg-[rgba(252,248,240,0.86)] px-6 py-10 shadow-[0_30px_80px_rgba(78,55,27,0.15)] backdrop-blur sm:px-10 sm:py-14 lg:px-16 lg:py-20">
          <header className="mx-auto mb-12 max-w-3xl border-b border-stone-700/10 pb-10 text-center">
            ...
            <div className="mt-5 flex flex-wrap justify-center gap-x-5 gap-y-2 text-sm">
              <Link
                href="/writing"
                className="inline-flex border-b border-stone-500/30 pb-1 text-stone-600 transition-colors hover:border-emerald-900 hover:text-emerald-900"
              >
                View all writing
              </Link>
              <Link
